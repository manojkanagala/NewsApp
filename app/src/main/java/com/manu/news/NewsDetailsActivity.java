...
public class NewsDetailsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        {
            Toast.makeText(NewsDetailsActivity.this, "Sorry Incorrect Details", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void updateNewsDetails(int index)
    {
        ...
        webView.setWebViewClient(new WebViewClient()
        {
            ...
            {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(NewsDetailsActivity.this, "Error in loading Webpage", Toast.LENGTH_LONG).show();
            }
        });
